...
Public Class Detalle
    ...
    Private Sub New(ctrl_objeto As ObjetoCtrl, grilla As ObjetoGrilla)
        ...
        btn_agregar.Location = New Point(control.Location.X + control.Size.Width + 15, control.Location.Y + control.Size.Height + 15)

        ' Grilla
        control = grilla_objeto
        control.MinimumSize = New Size(btn_agregar.Location.X + btn_agregar.Size.Width + 15, 150)
        control.Location = New Point(Me.Padding.Left, btn_agregar.Location.Y + btn_agregar.Size.Height + 15)
        control.TabIndex = 3
        Me.Controls.Add(control)

        btn_eliminar.Location = New Point(control.Location.X + control.Size.Width - btn_eliminar.Size.Width - 15,
                                          control.Location.Y + control.Size.Height + 15)
    End Sub
