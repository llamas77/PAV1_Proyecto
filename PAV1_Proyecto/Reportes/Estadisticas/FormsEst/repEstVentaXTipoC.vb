Public Class repEstVentaXTipoC
    ...
    Private Sub buscar()
        ...
        Dim sql = "SELECT tc.nombre as tipo_cliente, ISNULL(SUM(dv.cantidad * dv.precio), 0) as monto_ventas "
        sql &= "FROM tipos_cliente tc "
        sql &= "LEFT JOIN clientes c ON tc.idTipo = c.idTipoCliente "
        ...
        ReinitializeViewer("PAV1_Proyecto.repEstVentaXTipoC.rdlc")
